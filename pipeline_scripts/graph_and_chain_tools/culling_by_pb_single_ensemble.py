...
input_path = "data/UT_chain_500000_steps_(RW := 0.3)_proper.jsonl"
output_path = "data/UT_chain_500000_steps_(RW := 0.3)_proper.jsonl"
...
for election in PI_elections:
    ...
    winnowed_pb_samples = []
    with jl.open(f"{top_dir}/data/UT_chain_500000_steps_(RW := 0.3)_proper.jsonl") as reader:
    ...
    with jl.open(f"{top_dir}/data/UT_chain_500000_winnowed_pb_{election.name}.jsonl", "w") as f:
